...
public class OrderController {
    ...
    public OrderController(OrderServiceImpel orderServiceImpel, ExpertServiceImpel expertServiceImpel, OfferServiceImpel offerServiceImpel) {
    ...
    public ResponseEntity<List<OrderDTO>> viewOrder(){
        List<OrderDTO> orderDTOList = orderServiceImpel.findAllByCustomerId(1);
        return ResponseEntity.ok(orderDTOList);
    }

    @GetMapping("/viewStartedOrder")
    public ResponseEntity<List<OrderDTO>> viewStartedOrder(){
        List<OrderDTO> orderDTOList = orderServiceImpel.findAllStartOrder(1);
        return ResponseEntity.ok(orderDTOList);
    }
    ...
    public ResponseEntity<List<OrderDTO>> viewStartedOrderByCity(){
        ...
        List<OrderDTO> orderDTOList = orderServiceImpel.findAllStartedOrderByCity(expert.getCity(),expert.getSubServices());
            return ResponseEntity.ok(orderDTOList);
    }
    ...
    public ResponseEntity<List<OrderDTO>> viewOrderForDone(){
        List<OrderDTO> orderDTOList = orderServiceImpel.findAllByCustomerIdAndOrderStatus(1, OrderStatus.STARTED);
        return ResponseEntity.ok(orderDTOList);
    }
    ...
    public ResponseEntity<List<OrderDTO>> viewOrderForPaid(){
        List<OrderDTO> orderDTOList = orderServiceImpel.findAllByCustomerIdAndOrderStatus(1, OrderStatus.DONE);
        return ResponseEntity.ok(orderDTOList);
    }
    ...
    public ResponseEntity<List<OrderDTO>> viewPaidOrder(){
        List<OrderDTO> orderDTOList = orderServiceImpel.findAllByCustomerIdAndOrderStatus(1, OrderStatus.PAID);
        return ResponseEntity.ok(orderDTOList);
    }
}
